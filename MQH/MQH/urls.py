...
router.register(r'questsma', quest_hub_views.QuestmaViewSet, basename='questsma')
router.register(r'genres', quest_hub_views.GenreViewSet)
router.register(r'organizers', quest_hub_views.OrganizerViewSet)
router.register(r'bookings', quest_hub_views.BookingViewSet, basename='bookings')
router.register(r'allbookings', quest_hub_views.AllBookingViewSet, basename='allbookings')
router.register(r'status', quest_hub_views.StatusViewSet)
